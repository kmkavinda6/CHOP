...
// First motor (62CH)
		kineticLight->setMotorChannel(1, 1, heightToDMX(motorHeights[0], calMinHeight, calMaxHeight, calMinDMX, calMaxDMX));
		...
		// Second motor (9CH)
		kineticLight->setMotorChannel(2, 1, heightToDMX(motorHeights[1], calMinHeight, calMaxHeight, calMinDMX, calMaxDMX));
		kineticLight->setMotorChannel(2, 2, 0); // Fine-tuning
		kineticLight->setMotorChannel(2, 3, static_cast<uint8_t>(clamp(speed, 0.0, 255.0)));

		// Third motor (9CH)
		kineticLight->setMotorChannel(3, 1, heightToDMX(motorHeights[2], calMinHeight, calMaxHeight, calMinDMX, calMaxDMX));
